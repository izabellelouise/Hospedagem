		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					frame.setTitle("Cria��o de Hospedagem");
	...
	public FrmHospedagem() {
		...
		btnCriar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(h != null) {
					...
					JOptionPane.showMessageDialog(null, "Hospedagem com esse c�digo j� existe.");
				}
				else {
		...
		btnExcluir.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int i = JOptionPane.showOptionDialog(null, "Deseja excluir esta Hospedagem?", "Exclus�o", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, opcoes, opcoes[0]);
