	...
	public FrmChale() {
		...
		btnInserir.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(c != null) {
					...
					JOptionPane.showMessageDialog(null, "Chale com este c�digo j� existente");
				}
				else {
		...
		btnExcluir.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int i = JOptionPane.showOptionDialog(null, "Deseja excluir esse Chal�?", "Exclus�o",JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, opcoes, opcoes[0]);
