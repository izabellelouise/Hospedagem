	...
	public FrmItem() {
		...
		btnInserir.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if(i2 != null) {
					...
					JOptionPane.showMessageDialog(null, "Item com este nome j� existente");
				}
				else {
		...
		btnExcluir.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int i2 = JOptionPane.showOptionDialog(null, "Deseja excluir esse Item?", "Exclus�o",JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, opcoes, opcoes[0]);
