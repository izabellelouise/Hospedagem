	...
	public FrmHospedagemServico() {
		...
		btnExcluir.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int i = JOptionPane.showOptionDialog(null, "Deseja excluir o Servi�o desta Hospedagem?", "Exclus�o", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, opcoes, opcoes[0]);
