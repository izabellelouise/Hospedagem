	...
	public FrmTelefone() {
		...
		btnInserir.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(i2 != null) {
					...
					JOptionPane.showMessageDialog(null, "Este telefone j� esta cadastrado");
				}
				else {
		...
		btnExcluir.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int i2 = JOptionPane.showOptionDialog(null, "Deseja excluir esse Telefone?", "Exclus�o",JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, opcoes, opcoes[0]);
